...
__attribute__ ((__noreturn__)) void rb_bug(const char*, ...) __attribute__((format(printf, 1, 2)));
...
VALUE rb_check_funcall(VALUE, ID, int, const VALUE*);static inline 
...
{
    rb_obj_write((VALUE)(klass), (VALUE *)(&((((struct RClass*)(klass))->ptr)->origin_)), (VALUE)(origin), "../ruby/internal.h", 823);
...
RCLASS_SET_SUPER(VALUE klass, VALUE super)
{
 ...
 rb_class_subclass_add(super, klass);
    ...
    rb_obj_write((VALUE)(klass), (VALUE *)(&((struct RClass*)(klass))->super), (VALUE)(super), "../ruby/internal.h", 841);
    return super;
}
...
const char *rb_source_location_cstr(int *pline);static inline 
void rb_vm_pop_cfunc_frame(void);
int rb_vm_add_root_module(ID id, VALUE module);
void rb_vm_check_redefinition_by_prepend(VALUE klass);
VALUE rb_yield_refine_block(VALUE refinement, VALUE refinements);static inline 
...
struct rb_method_definition_struct { rb_method_type_t type : 4; int alias_count : 28; int complemented_count : 28; union { rb_method_iseq_t iseq; rb_method_cfunc_t cfunc; rb_method_attr_t attr; rb_method_alias_t alias; rb_method_refined_t refined; const VALUE proc; enum method_optimized_type optimize_type; } body; ID original_id;} __attribute__((packed));
...
VALUE rb_vm_call(rb_execution_context_t *ec, VALUE recv, VALUE id, int argc,
   const VALUE *argv, const rb_callable_method_entry_t *me);static inline 
...
{
    list_add_tail_(&vm->living_threads, &th->vmlt_node, "../ruby/vm_core.h" ":" "1595");
...
{
    list_del_(&th->vmlt_node, "../ruby/vm_core.h" ":" "1602");
    vm->living_thread_num--;
}
...
void rb_vm_rewind_cfp(rb_execution_context_t *ec, rb_control_frame_t *cfp);static inline 
...
void rb_vm_rewrite_cref(rb_cref_t *node, VALUE old_klass, VALUE new_klass, rb_cref_t **new_cref_ptr);static inline 
...
rb_vm_block_ep_update(VALUE obj, const struct rb_block *dst, const VALUE *ep)
{
    *((const VALUE **)&dst->as.captured.ep) = ep;
    rb_obj_written((VALUE)(obj), (VALUE)(((VALUE)RUBY_Qundef)), (VALUE)(VM_ENV_ENVVAL(ep)), "../ruby/vm.c", 282);
}
...
vm_bind_update_env(VALUE bindval, rb_binding_t *bind, VALUE envval)
{
    ...
    __extension__({
;
; typeof(rb_obj_write((VALUE)(bindval), (VALUE *)(&bind->block.as.captured.code.iseq), (VALUE)(env->iseq), "../ruby/vm.c", 289)) unaligned_member_access_result = (rb_obj_write((VALUE)(bindval), (VALUE *)(&bind->block.as.captured.code.iseq), (VALUE)(env->iseq), "../ruby/vm.c", 289));
; unaligned_member_access_result; });
...
static rb_control_frame_t *vm_get_ruby_level_caller_cfp(const rb_execution_context_t *ec, const rb_control_frame_t *cfp);static inline 
...
__attribute__ ((__noreturn__)) void rb_ec_stack_overflow(rb_execution_context_t *ec, int crit);static inline 
void
...
lep_svar_write(const rb_execution_context_t *ec, const VALUE *lep, const struct vm_svar *svar)
{
 ...
 __extension__({
;
; typeof(rb_obj_write((VALUE)(rb_ec_thread_ptr(ec)->self), (VALUE *)(&ec->root_svar), (VALUE)(svar), "../ruby/vm_insnhelper.c", 413)) unaligned_member_access_result = (rb_obj_write((VALUE)(rb_ec_thread_ptr(ec)->self), (VALUE *)(&ec->root_svar), (VALUE)(svar), "../ruby/vm_insnhelper.c", 413));
; unaligned_member_access_result; });
    }
}
...
lep_svar_set(const rb_execution_context_t *ec, const VALUE *lep, rb_num_t key, VALUE val)
{
 ...
 __extension__({
;
; typeof(rb_obj_write((VALUE)(svar), (VALUE *)(&svar->lastline), (VALUE)(val), "../ruby/vm_insnhelper.c", 459)) unaligned_member_access_result = (rb_obj_write((VALUE)(svar), (VALUE *)(&svar->lastline), (VALUE)(val), "../ruby/vm_insnhelper.c", 459));
; unaligned_member_access_result; });
 return;
      case VM_SVAR_BACKREF:
 __extension__({
;
; typeof(rb_obj_write((VALUE)(svar), (VALUE *)(&svar->backref), (VALUE)(val), "../ruby/vm_insnhelper.c", 462)) unaligned_member_access_result = (rb_obj_write((VALUE)(svar), (VALUE *)(&svar->backref), (VALUE)(val), "../ruby/vm_insnhelper.c", 462));
; unaligned_member_access_result; });
 return;
      default: {
 ...
 if (!((VALUE)(ary) != ((VALUE)RUBY_Qnil))) {
     __extension__({
;
; typeof(rb_obj_write((VALUE)(svar), (VALUE *)(&svar->others), (VALUE)(ary = rb_ary_new()), "../ruby/vm_insnhelper.c", 468)) unaligned_member_access_result = (rb_obj_write((VALUE)(svar), (VALUE *)(&svar->others), (VALUE)(ary = rb_ary_new()), "../ruby/vm_insnhelper.c", 468));
; unaligned_member_access_result; });
 }
...
cref_replace_with_duplicated_cref_each_frame(const VALUE *vptr, int can_be_svar, VALUE parent)
{
 ...
 switch (imemo_type(v)) {
  ...
  __extension__({
;
; typeof(rb_obj_write((VALUE)(parent), (VALUE *)(vptr), (VALUE)(new_cref), "../ruby/vm_insnhelper.c", 643)) unaligned_member_access_result = (rb_obj_write((VALUE)(parent), (VALUE *)(vptr), (VALUE)(new_cref), "../ruby/vm_insnhelper.c", 643));
; unaligned_member_access_result; });
     }
     else {
...
__attribute__ ((__always_inline__)) static VALUE vm_getivar(VALUE, ID, IC, struct rb_call_cache *, st_index_t, int);
static inline VALUE
vm_getivar(VALUE obj, ID id, IC ic, struct rb_call_cache *cc, st_index_t index, int is_attr)
{
 ...
 VALUE val = ((VALUE)RUBY_Qundef);
        if ((__builtin_expect(!!(index > 0 || is_attr ? (cc->aux.index > 0) : (ic->ic_serial == ((((struct RClass*)(((struct RBasic*)(obj))->klass))->ptr)->class_serial))), 1))) {
...
vm_setivar(VALUE obj, ID id, VALUE val, IC ic, struct rb_call_cache *cc, int is_attr) {
    ...
    __extension__({do { VALUE frozen_obj = (obj); if ((__builtin_expect(!!((!(!(((VALUE)(frozen_obj) & RUBY_IMMEDIATE_MASK) || !!(((VALUE)(frozen_obj) & (VALUE)~((VALUE)RUBY_Qnil)) == 0)) && (int)(((struct RBasic*)(frozen_obj))->flags & RUBY_T_MASK) != RUBY_T_NODE) || (((struct RBasic*)(frozen_obj))->flags&RUBY_FL_FREEZE))), 0))) { rb_error_frozen_object(frozen_obj); } } while (0);});
 ...
 if ((__builtin_expect(!!((!is_attr && (ic->ic_serial == ((((struct RClass*)(klass))->ptr)->class_serial))) || ( is_attr && (cc->aux.index > 0))), 1))) {
  ...
  __extension__({
;
; typeof(rb_obj_write((VALUE)(obj), (VALUE *)(&ptr[index]), (VALUE)(val), "../ruby/vm_insnhelper.c", 1006)) unaligned_member_access_result = (rb_obj_write((VALUE)(obj), (VALUE *)(&ptr[index]), (VALUE)(val), "../ruby/vm_insnhelper.c", 1006));
; unaligned_member_access_result; });
  ((void)0);
  return val;
     }
...
static inline VALUE
vm_getinstancevariable(VALUE obj, ID id, IC ic) {
    return vm_getivar(obj, id, ic, ((void*)0), 0, 0);
}
...
args_check_block_arg0(struct args_info *args)
{
 ...
 VALUE arg0 = (rb_array_const_ptr(args->rest)[0]);
...
args_copy(struct args_info *args)
{
 ...
 while (args->rest_index > 0 && argc > 0) {
     do { const VALUE _ary = (args->rest); VALUE *ptr = (VALUE *)((VALUE *)rb_array_const_ptr(_ary)); __extension__({
;
; typeof(rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[--args->rest_index]), (VALUE)((args->argv[--argc])), "../ruby/vm_args.c", 140)) unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[--args->rest_index]), (VALUE)((args->argv[--argc])), "../ruby/vm_args.c", 140));
; unaligned_member_access_result; }); ; } while (0);
 }
 while (argc > 0) {
...
{
    return rb_array_const_ptr(args->rest) + args->rest_index;
}
...
args_rest_array(struct args_info *args)
{
    ...
    if (args->rest) {
 ary = rb_ary_subseq(args->rest, args->rest_index, rb_array_len(args->rest) - args->rest_index);
 args->rest = 0;
    }
    else {
 ary = rb_ary_new();
 ...
 *kw_hash_ptr = args->argv[args->argc-1];
 ...
 if (len > 0) {
     *kw_hash_ptr = (rb_array_const_ptr(args->rest)[len - 1]);

     if (keyword_hash_p(kw_hash_ptr, &rest_hash)) {
  if (rest_hash) {
      do { const VALUE _ary = (args->rest); VALUE *ptr = (VALUE *)((VALUE *)rb_array_const_ptr(_ary)); __extension__({
;
; typeof(rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[len - 1]), (VALUE)((rest_hash)), "../ruby/vm_args.c", 219)) unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[len - 1]), (VALUE)((rest_hash)), "../ruby/vm_args.c", 219));
; unaligned_member_access_result; }); ; } while (0);
  }
  else {
      args->rest = rb_ary_dup(args->rest);
...
args_setup_post_parameters(struct args_info *args, int argc, VALUE *locals)
{
    ...
    __builtin___memcpy_chk ((locals), (rb_array_const_ptr(args->rest) + len - argc), sizeof(VALUE)*(size_t)(argc), __builtin_object_size ((locals), 0));
...
args_setup_opt_parameters(struct args_info *args, int opt_max, VALUE *locals)
{
 ...
 if (args->rest) {
     ...
     const VALUE *argv = rb_array_const_ptr(args->rest);
    ...
    VALUE * const locals, const enum arg_setup_type arg_setup_type)
{
 ...
 if (args->kw_argv != ((void*)0)) {
     ...
     int kw_len = rb_long2int_inline((((struct RHash*)(keyword_hash))->ntbl ? ((struct RHash*)(keyword_hash))->ntbl->num_entries : (st_index_t)0));
 ...
 args_setup_kw_rest_parameter(keyword_hash, locals + iseq->body->param.keyword->rest_start);
    ...
    else if (!!((VALUE)(keyword_hash) != ((VALUE)RUBY_Qnil)) && (((struct RHash*)(keyword_hash))->ntbl ? ((struct RHash*)(keyword_hash))->ntbl->num_entries : (st_index_t)0) > 0) {
...
vm_to_proc(VALUE proc)
{
 ...
 if (me) {
     b = vm_call0(rb_current_execution_context(), proc, idTo_proc, 0, ((void*)0), me);
 }
 else {
...
refine_sym_proc_call(VALUE yielded_arg, VALUE callback_arg, int argc, const VALUE *argv, VALUE blockarg)
{
 ...
 rb_raise(rb_eArgError, "no receiver given");
    ...
    me = rb_callable_method_entry_with_refinements(rb_class_of((VALUE)(obj)), mid, ((void*)0));
     ...
     struct rb_calling_info *calling, const struct rb_call_info *ci, rb_iseq_t *blockiseq, const int is_super)
{
 ...
 if (is_super) {
     calling->block_handler = ((VM_EP_LEP(((((reg_cfp)->ep)))))[(-1)]);
 }
 else {
     calling->block_handler = 0;
 }
...
vm_call_cfunc_with_frame(rb_execution_context_t *ec, rb_control_frame_t *reg_cfp, struct rb_calling_info *calling, const struct rb_call_info *ci, struct rb_call_cache *cc)
{
    ...
    do { const rb_event_flag_t flag_arg_ = (0x0020); if ((__builtin_expect(!!(ruby_vm_event_flags & (flag_arg_)), 0))) { rb_exec_event_hook_orig(ec, flag_arg_, recv, me->def->original_id, ci->mid, me->owner, ((VALUE)RUBY_Qundef), 0); } } while (0);
    ...
    do { const rb_event_flag_t flag_arg_ = (0x0040); if ((__builtin_expect(!!(ruby_vm_event_flags & (flag_arg_)), 0))) { rb_exec_event_hook_orig(ec, flag_arg_, recv, me->def->original_id, ci->mid, me->owner, val, 0); } } while (0);
    do { if ((__builtin_expect(!!(0), 0))) { struct ruby_dtrace_method_hook_args args; if (rb_dtrace_setup(ec, me->owner, me->def->original_id, &args)) { do {} while (0); } } } while (0);
...
{
    cfp->sp -= 1;
    return vm_getivar(calling->recv, cc->me->def->body.attr.id, ((void*)0), cc, 0, 1);
}
...
vm_call_bmethod_body(rb_execution_context_t *ec, struct rb_calling_info *calling, const struct rb_call_info *ci, struct rb_call_cache *cc, const VALUE *argv)
{
    ...
    (((proc)) = (rb_proc_t*)(((struct RData*)(((cc->me->def->body.proc))))->data));
...
aliased_callable_method_entry(const rb_callable_method_entry_t *me)
{
 ...
 if (me->def->alias_count + me->def->complemented_count == 0) {
     __extension__({
;
; typeof(rb_obj_write((VALUE)(me), (VALUE *)(&me->def->body.alias.original_me), (VALUE)(cme), "../ruby/vm_insnhelper.c", 2220)) unaligned_member_access_result = (rb_obj_write((VALUE)(me), (VALUE *)(&me->def->body.alias.original_me), (VALUE)(cme), "../ruby/vm_insnhelper.c", 2220));
; unaligned_member_access_result; });
 }
 else {
...
vm_call_method_each_type(rb_execution_context_t *ec, rb_control_frame_t *cfp, struct rb_calling_info *calling, const struct rb_call_info *ci, struct rb_call_cache *cc)
{
 ...
 return vm_call_zsuper(ec, cfp, calling, ci, cc, ((((struct RClass*)(cc->me->owner))->ptr)->origin_));
         ...
         struct rb_calling_info *calling, struct rb_call_info *ci, struct rb_call_cache *cc)
{
    ...
    VALUE sigval = (*(((((reg_cfp)->sp)))-(calling->argc)-1));
...
vm_callee_setup_block_arg_arg0_splat(rb_control_frame_t *cfp, const rb_iseq_t *iseq, VALUE *argv, VALUE ary)
{
 ...
 argv[i] = (rb_array_const_ptr(ary)[i]);
    }
        ...
        const struct rb_captured_block *captured)
{
    ...
    do { if ((__builtin_expect(!!(((ci)->flag & (0x01 << VM_CALL_ARGS_SPLAT_bit))), 0))) vm_caller_setup_arg_splat((ec->cfp), (calling)); if ((__builtin_expect(!!(((ci)->flag & (0x01 << VM_CALL_KWARG_bit))), 0))) vm_caller_setup_arg_kw((ec->cfp), (calling), (ci)); } while (0);
    argc = calling->argc;
    val = vm_yield_with_cfunc(ec, captured, captured->self, argc, (((((reg_cfp)->sp)))-(argc)), calling->block_handler);
    ((((reg_cfp)->sp) -= (((argc)))));
    return val;
}
...
vm_check_match(rb_execution_context_t *ec, VALUE target, VALUE pattern, rb_num_t flag)
{
 ...
 for (i = 0; i < n; i++) {
     VALUE v = (rb_array_const_ptr(pattern)[i]);
...
vm_opt_str_freeze(VALUE str, int bop, ID id)
{
 ...
 return __extension__({ const int rb_funcall_argc = (0); const VALUE rb_funcall_args[] = {}; const int rb_funcall_nargs = (int)(sizeof(rb_funcall_args) / sizeof(VALUE)); rb_funcallv(rb_str_resurrect(str), id, __builtin_choose_expr(__builtin_constant_p(rb_funcall_argc), (((rb_funcall_argc) == 0 ? (rb_funcall_nargs) <= 1 : (rb_funcall_argc) == (rb_funcall_nargs)) ? (rb_funcall_argc) : ((rb_funcall_argc)/((rb_funcall_argc) == 0 ? (rb_funcall_nargs) <= 1 : (rb_funcall_argc) == (rb_funcall_nargs)))), (((rb_funcall_argc) <= (rb_funcall_nargs)) ? (rb_funcall_argc) : (rb_fatal("argc(%d) exceeds actual arguments(%d)", rb_funcall_argc, rb_funcall_nargs), 0))), rb_funcall_nargs ? rb_funcall_args : ((void*)0)); });
    }
}
...
vm_once_dispatch(rb_execution_context_t *ec, ISEQ iseq, ISE is)
{
 ...
 __extension__({
;
; typeof(rb_obj_write((VALUE)(ec->cfp->iseq), (VALUE *)(&is->once.value), (VALUE)(val), "../ruby/vm_insnhelper.c", 3317)) unaligned_member_access_result = (rb_obj_write((VALUE)(ec->cfp->iseq), (VALUE *)(&is->once.value), (VALUE)(val), "../ruby/vm_insnhelper.c", 3317));
; unaligned_member_access_result; });
...
vm_case_dispatch(CDHASH hash, OFFSET else_offset, VALUE key)
{
 ...
 if (((__builtin_expect(!!((rb_current_vm()->redefined_flag[(BOP_EQQ)]&((1 << 6) | (1 << 0) | (1 << 1) | (1 << 9) | (1 << 10) | (1 << 11) | (1 << 2))) == 0), 1)))) {
  ...
  if (!( sizeof(kval) == sizeof(float) ? __inline_isinff((float)(kval)) : sizeof(kval) == sizeof(double) ? __inline_isinfd((double)(kval)) : __inline_isinfl((long double)(kval))) && modf(kval, &kval) == 0.0) {
     ...
     if (st_lookup(rb_hash_tbl_raw(hash), key, &val)) {
  return ((int)rb_fix2int((VALUE)((VALUE)val)));
     }
     else {
  return else_offset;
     }
...
vm_opt_length(VALUE recv, int bop)
{
 ...
 return (((VALUE)((((struct RHash*)(recv))->ntbl ? ((struct RHash*)(recv))->ntbl->num_entries : (st_index_t)0)))<<1 | RUBY_FIXNUM_FLAG);
    }
    else {
 return ((VALUE)RUBY_Qundef);
    }
...
vm_opt_succ(VALUE recv)
{
 ...
 if (recv == (((VALUE)((9223372036854775807L>>1)))<<1 | RUBY_FIXNUM_FLAG)) {
...
vm_trace(rb_execution_context_t *ec, rb_control_frame_t *reg_cfp, const VALUE *pc)
{
 ...
 if (event = (events & (0x0002 | 0x0008 | 0x0100))) {
     ((void)0);


     reg_cfp->pc++;
     vm_dtrace(event, ec);
     do { const rb_event_flag_t flag_arg_ = (event); if ((__builtin_expect(!!(ruby_vm_event_flags & (flag_arg_)), 0))) { rb_exec_event_hook_orig(ec, flag_arg_, (((((reg_cfp)))->self)), 0, 0, 0, ((VALUE)RUBY_Qundef), 0); } } while (0);
     reg_cfp->pc--;
 }
 if (events & 0x0001) {
     reg_cfp->pc++;
     vm_dtrace(0x0001, ec);
     do { const rb_event_flag_t flag_arg_ = (0x0001); if ((__builtin_expect(!!(ruby_vm_event_flags & (flag_arg_)), 0))) { rb_exec_event_hook_orig(ec, flag_arg_, (((((reg_cfp)))->self)), 0, 0, 0, ((VALUE)RUBY_Qundef), 0); } } while (0);
     reg_cfp->pc--;
 }
 if (event = (events & (0x0004 | 0x0010 | 0x0200))) {
     ((void)0);


     reg_cfp->pc++;
     vm_dtrace(event, ec);
     do { const rb_event_flag_t flag_arg_ = (event); if ((__builtin_expect(!!(ruby_vm_event_flags & (flag_arg_)), 0))) { rb_exec_event_hook_orig(ec, flag_arg_, (((((reg_cfp)))->self)), 0, 0, 0, (*(((((reg_cfp)->sp)))-(0)-1)), 0); } } while (0);
     reg_cfp->pc--;
 }
    }
}
       ...
       enum method_missing_reason last_call_status)
{
 ...
 format = __extension__ ({ (__builtin_constant_p("private method `%s' called for %s%s%s")) ? rb_fstring_new(("private method `%s' called for %s%s%s"), (long)strlen("private method `%s' called for %s%s%s")) : rb_fstring_cstr("private method `%s' called for %s%s%s"); });
    }
    else if (last_call_status & MISSING_PROTECTED) {
 format = __extension__ ({ (__builtin_constant_p("protected method `%s' called for %s%s%s")) ? rb_fstring_new(("protected method `%s' called for %s%s%s"), (long)strlen("protected method `%s' called for %s%s%s")) : rb_fstring_cstr("protected method `%s' called for %s%s%s"); });
    }
    else if (last_call_status & MISSING_VCALL) {
 format = __extension__ ({ (__builtin_constant_p("undefined local variable or method `%s' for %s%s%s")) ? rb_fstring_new(("undefined local variable or method `%s' for %s%s%s"), (long)strlen("undefined local variable or method `%s' for %s%s%s")) : rb_fstring_cstr("undefined local variable or method `%s' for %s%s%s"); });
 exc = rb_eNameError;
    }
    else if (last_call_status & MISSING_SUPER) {
 format = __extension__ ({ (__builtin_constant_p("super: no superclass method `%s' for %s%s%s")) ? rb_fstring_new(("super: no superclass method `%s' for %s%s%s"), (long)strlen("super: no superclass method `%s' for %s%s%s")) : rb_fstring_cstr("super: no superclass method `%s' for %s%s%s"); });
    }
...
method_missing(VALUE obj, ID id, int argc, const VALUE *argv, enum method_missing_reason call_status)
{
 ...
 raise_method_missing(ec, argc, argv, obj, call_status | MISSING_MISSING);
    ...
    nargv = ((VALUE*)(((size_t)(argc + 1) < 1024 / sizeof(VALUE)) ? ((*__extension__ ({ volatile VALUE *rb_gc_guarded_ptr = &(work); __asm__("" : : "m"(rb_gc_guarded_ptr)); rb_gc_guarded_ptr; })) = 0, __builtin_alloca((size_t)(argc + 1) * sizeof(VALUE))) : rb_alloc_tmp_buffer2(&(work), (long)(argc + 1), sizeof(VALUE))));
...
rb_vm_pop_cfunc_frame(void)
{
    ...
    do { const rb_event_flag_t flag_arg_ = (0x0040); if ((__builtin_expect(!!(ruby_vm_event_flags & (flag_arg_)), 0))) { rb_exec_event_hook_orig(ec, flag_arg_, cfp->self, me->def->original_id, me->called_id, me->owner, ((VALUE)RUBY_Qnil), 0); } } while (0);
    do { if ((__builtin_expect(!!(0), 0))) { struct ruby_dtrace_method_hook_args args; if (rb_dtrace_setup(ec, me->owner, me->def->original_id, &args)) { do {} while (0); } } } while (0);
    vm_pop_frame(ec, cfp, cfp->ep);
}
...
#define RUBY_PLATFORM "x86_64-darwin17"
...
#define __MAC_OS_X_VERSION_MAX_ALLOWED __MAC_10_13_4
...
#define RARRAY_ASET(a,i,v) do { const VALUE _ary = (a); VALUE *ptr = (VALUE *)RARRAY_PTR_USE_START(_ary); RB_OBJ_WRITE(_ary, &ptr[i], (v)); RARRAY_PTR_USE_END(_ary); } while (0)
...
#define RB_ALLOCV(v,n) ((n) < RUBY_ALLOCV_LIMIT ? (RB_GC_GUARD(v) = 0, alloca(n)) : rb_alloc_tmp_buffer(&(v), (n)))
#define RB_ALLOCV_N(type,v,n) ((type*)(((size_t)(n) < RUBY_ALLOCV_LIMIT / sizeof(type)) ? (RB_GC_GUARD(v) = 0, alloca((size_t)(n) * sizeof(type))) : rb_alloc_tmp_buffer2(&(v), (long)(n), sizeof(type))))
...
#define rb_thread_set_current(th) do { if ((th)->vm->running_thread != (th)) { (th)->running_time_us = 0; } rb_thread_set_current_raw(th); (th)->vm->running_thread = (th); } while (0)
...
#define EXEC_EVENT_HOOK_ORIG(ec_,flag_,vm_flags_,self_,id_,called_id_,klass_,data_,pop_p_) do { const rb_event_flag_t flag_arg_ = (flag_); if (UNLIKELY(vm_flags_ & (flag_arg_))) { rb_exec_event_hook_orig(ec_, flag_arg_, self_, id_, called_id_, klass_, data_, pop_p_); } } while (0)
#define EXEC_EVENT_HOOK(ec_,flag_,self_,id_,called_id_,klass_,data_) EXEC_EVENT_HOOK_ORIG(ec_, flag_, ruby_vm_event_flags, self_, id_, called_id_, klass_, data_, 0)
#define EXEC_EVENT_HOOK_AND_POP_FRAME(ec_,flag_,self_,id_,called_id_,klass_,data_) EXEC_EVENT_HOOK_ORIG(ec_, flag_, ruby_vm_event_flags, self_, id_, called_id_, klass_, data_, 1)
#pragma GCC visibility push(default)
...
#define ISEQ_TRACE_EVENTS (RUBY_EVENT_LINE | RUBY_EVENT_CLASS | RUBY_EVENT_END | RUBY_EVENT_CALL | RUBY_EVENT_RETURN| RUBY_EVENT_B_CALL| RUBY_EVENT_B_RETURN)
...
#define UNALIGNED_MEMBER_ACCESS(expr) __extension__({ _Pragma("GCC diagnostic push"); _Pragma("GCC diagnostic ignored \"-Waddress-of-packed-member\""); typeof(expr) unaligned_member_access_result = (expr); _Pragma("GCC diagnostic pop"); unaligned_member_access_result; })
...
#define CI_SET_FASTPATH(cc,func,enabled) do { if (LIKELY(enabled)) ((cc)->call = (func)); } while (0)
#define GET_BLOCK_HANDLER() (GET_LEP()[VM_ENV_DATA_INDEX_SPECVAL])
#define WIDTH_OF_opt_send_without_block ((rb_snum_t)attr_width_opt_send_without_block(0, 0))
