...
ECHO1 = $(V:1=@:)
ECHO = $(ECHO1:0=@echo)
extensions = ext/strscan/. ext/syslog/. ext/gdbm/. ext/pty/. \
	     ext/objspace/. ext/nkf/. ext/digest/. \
	     ext/digest/bubblebabble/. ext/digest/md5/. \
	     ext/digest/rmd160/. ext/digest/sha1/. ext/digest/sha2/. \
	     ext/date/. ext/readline/. ext/io/console/. \
	     ext/io/nonblock/. ext/io/wait/. ext/etc/. \
	     ext/bigdecimal/. ext/-test-/array/resize/. \
	     ext/-test-/bignum/. ext/-test-/bug-3571/. \
	     ext/-test-/bug-5832/. ext/-test-/bug_reporter/. \
	     ext/-test-/class/. ext/-test-/debug/. \
	     ext/-test-/dln/empty/. ext/-test-/exception/. \
	     ...
	     ext/fiddle/. ext/rubyvm/. ext/zlib/. ext/psych/. \
	     ext/cgi/escape/. ext/json/. ext/json/generator/. \
	     ext/json/parser/. ext/stringio/. ext/racc/cparse/. \
	     ext/fiber/. ext/sdbm/. ext/continuation/. \
	     ext/rbconfig/sizeof/. ext/dbm/. ext/fcntl/. ext/openssl/. \
	     ext/ripper/. ext/pathname/. ext/coverage/. ext/socket/.
EXTOBJS = dmyext.o
