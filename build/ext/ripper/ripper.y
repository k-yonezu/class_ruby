...
%type <val> top_compstmt top_stmts top_stmt begin_block
%type <val> bodystmt compstmt stmts stmt_or_begin stmt expr arg primary command command_call method_call
%type <val> expr_value expr_value_do arg_value primary_value fcall rel_expr
...
%token tLSHFT		134 "<<"
%token tRSHFT		135 ">>"
%token <val> tANDDOT	148 "&."
%token <val> tCOLON2	145 "::"
...
#endif
			{VALUE v1,v2,v3,v4,v5;v1=escape_Qundef($1);v2=escape_Qundef($2);v3=escape_Qundef($5);v4=escape_Qundef($6);v5=dispatch4(bodystmt,v1,v2,v3,v4);$$=v5;}
		    }
		| compstmt
		  opt_rescue
		  opt_ensure
...
#endif
			{VALUE v1,v2,v3,v4,v5;v1=escape_Qundef($1);v2=escape_Qundef($2);v3=Qnil;v4=escape_Qundef($3);v5=dispatch4(bodystmt,v1,v2,v3,v4);$$=v5;}
		    }
		;
...
stmt		: keyword_alias fitem {SET_LEX_STATE(EXPR_FNAME|EXPR_FITEM);} fitem
		...
		| keyword_alias tGVAR tNTH_REF
			...
			$$ = NEW_BEGIN(0, &@$);
#endif
			{VALUE v1,v2,v3,v4,v5;v1=$2;v2=$3;v3=dispatch2(var_alias,v1,v2);v4=v3;v5=dispatch1(alias_error,v4);$$=v5;}ripper_error(p);
		    }
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(rescue_mod,v1,v2);$$=v3;}
		    }
...
#endif
			{VALUE v1,v2;v1=$3;v2=dispatch1(END,v1);$$=v2;}
		    }
		| command_asgn
		| mlhs '=' command_call
		    {
			...
			$$ = node_assign(p, $1, $3, &@$);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(massign,v1,v2);$$=v3;}
		    }
		| lhs '=' mrhs
		    {
#if 0
...
command_asgn	: lhs '=' command_rhs
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7;v1=$1;v2=$3;v3=dispatch2(const_path_field,v1,v2);v4=v3;v5=$4;v6=$5;v7=dispatch3(opassign,v4,v5,v6);$$=v7;}
		    }
		...
		| backref tOP_ASGN command_rhs
			...
			$$ = NEW_BEGIN(0, &@$);
#endif
			{VALUE v1,v2,v3,v4,v5;v1=var_field(p, $1);v2=$3;v3=dispatch2(assign,v1,v2);v4=v3;v5=dispatch1(assign_error,v4);$$=v5;}ripper_error(p);
		    }
		;
...
mlhs_node	: user_variable
		...
		| primary_value '[' opt_call_args rbracket
			...
			$$ = aryset(p, $1, $3, &@$);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=escape_Qundef($3);v3=dispatch2(aref_field,v1,v2);$$=v3;}
		    }
		...
		| backref
			...
			$$ = NEW_BEGIN(0, &@$);
#endif
			{VALUE v1,v2;v1=var_field(p, $1);v2=dispatch1(assign_error,v1);$$=v2;}ripper_error(p);
		    }
		;
...
#endif
			{VALUE v1,v2;v1=$1;v2=dispatch1(class_name_error,v1);$$=v2;}ripper_error(p);
		    }
		| tCONSTANT
		;
...
arg		: lhs '=' arg_rhs
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=$2;v2=dispatch1(top_const_field,v1);v3=v2;v4=$3;v5=$4;v6=dispatch3(opassign,v3,v4,v5);$$=v6;}
		    }
		| backref tOP_ASGN arg_rhs
			...
			$$ = NEW_BEGIN(0, &@$);
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=var_field(p, $1);v2=$2;v3=$3;v4=dispatch3(opassign,v1,v2,v3);v5=v4;v6=dispatch1(assign_error,v5);$$=v6;}ripper_error(p);
		    }
		| arg tDOT2 arg
		    {
#if 0
...
primary		: literal
		...
		| tLPAREN_ARG {SET_LEX_STATE(EXPR_ENDARG);} rparen
			...
			$$ = NEW_BEGIN(0, &@$);
#endif
			{VALUE v1,v2;v1=0;v2=dispatch1(paren,v1);$$=v2;}
		    }
		...
		| tLBRACK aref_args ']'
			...
			$$ = make_array($2, &@$);
#endif
			{VALUE v1,v2;v1=escape_Qundef($2);v2=dispatch1(array,v1);$$=v2;}
		    }
		| tLBRACE assoc_list '}'
		    {
#if 0
			...
			$$->nd_alen = TRUE;
#endif
			{VALUE v1,v2;v1=escape_Qundef($2);v2=dispatch1(hash,v1);$$=v2;}
		    }
		| k_return
		    {
#if 0
		...
		| k_if expr_value then
		  ...
		  k_end
			...
			fixpos($$, $2);
#endif
			{VALUE v1,v2,v3,v4;v1=$2;v2=$4;v3=escape_Qundef($5);v4=dispatch3(if,v1,v2,v3);$$=v4;}
		    }
		| k_unless expr_value then
		  ...
		  k_end
			...
			fixpos($$, $2);
#endif
			{VALUE v1,v2,v3,v4;v1=$2;v2=$4;v3=escape_Qundef($5);v4=dispatch3(unless,v1,v2,v3);$$=v4;}
		    }
		...
		| k_case opt_terms case_body k_end
			...
			$$ = NEW_CASE2($3, &@$);
#endif
			{VALUE v1,v2,v3;v1=Qnil;v2=$3;v3=dispatch2(case,v1,v2);$$=v3;}
		    }
...
#endif
			{VALUE v1,v2,v3,v4;v1=$2;v2=$3;v3=$5;v4=dispatch3(class,v1,v2,v3);$$=v4;}
			local_pop(p);
			p->in_class = $<num>1 & 1;
		    }
		| k_class tLSHFT expr
		  ...
		  k_end
			...
			fixpos($$, $3);
#endif
			{VALUE v1,v2,v3;v1=$3;v2=$6;v3=dispatch2(sclass,v1,v2);$$=v3;}
			local_pop(p);
			p->in_def = $<num>4 & 1;
...
#endif
			{VALUE v1,v2,v3;v1=$2;v2=$4;v3=dispatch2(module,v1,v2);$$=v3;}
			local_pop(p);
			p->in_class = $<num>1 & 1;
		    }
		| k_def fname
...
#endif
			{VALUE v1,v2,v3,v4;v1=$2;v2=$5;v3=$6;v4=dispatch3(def,v1,v2,v3);$$=v4;}
			local_pop(p);
			p->in_def = $<num>4 & 1;
			p->cur_arg = $<id>3;
		    }
		| k_def singleton dot_or_colon {SET_LEX_STATE(EXPR_FNAME);} fname
		  ...
		  k_end
			...
			set_line_body(body, @1.beg_pos.lineno);
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=$2;v2=$3;v3=$5;v4=$7;v5=$8;v6=dispatch5(defs,v1,v2,v3,v4,v5);$$=v6;}
			local_pop(p);
			p->in_def = $<num>4 & 1;
			p->cur_arg = $<id>6;
		    }
...
if_tail		: opt_else
		| k_elsif expr_value then
		  ...
		  if_tail
			...
			fixpos($$, $2);
#endif
			{VALUE v1,v2,v3,v4;v1=$2;v2=$4;v3=escape_Qundef($5);v4=dispatch3(elsif,v1,v2,v3);$$=v4;}
		    }
		;
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=assignable(p, $4);v3=dispatch2(mlhs_add_star,v1,v2);$$=v3;}
		    }
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=$1;v2=assignable(p, $4);v3=dispatch2(mlhs_add_star,v1,v2);v4=v3;v5=$6;v6=dispatch2(mlhs_add_post,v4,v5);$$=v6;}
		    }
		| f_marg_list ',' tSTAR
		    {
#if 0
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=$1;v2=Qnil;v3=dispatch2(mlhs_add_star,v1,v2);v4=v3;v5=$5;v6=dispatch2(mlhs_add_post,v4,v5);$$=v6;}
		    }
		| tSTAR f_norm_arg
		    {
#if 0
...
#endif
			{VALUE v1,v2,v3,v4;v1=dispatch0(mlhs_new);v2=v1;v3=assignable(p, $2);v4=dispatch2(mlhs_add_star,v2,v3);$$=v4;}
		    }
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7;v1=dispatch0(mlhs_new);v2=v1;v3=assignable(p, $2);v4=dispatch2(mlhs_add_star,v2,v3);v5=v4;v6=$4;v7=dispatch2(mlhs_add_post,v5,v6);$$=v7;}
		    }
		| tSTAR
		    {
#if 0
...
#endif
			{VALUE v1;v1=dispatch0(excessed_comma);$$=new_args(p, $1, Qnone, v1, Qnone, new_args_tail(p, Qnone, Qnone, Qnone, NULL), NULL);}
		    }
...
block_param_def	: '|' opt_bv_decl '|'
			...
			$$ = 0;
#endif
			{VALUE v1,v2,v3;v1=params_new(Qnil, Qnil, Qnil, Qnil, Qnil, Qnil, Qnil);v2=escape_Qundef($2);v3=dispatch2(block_var,v1,v2);$$=v3;}
		    }
		| tOROP
		    {
#if 0
			$$ = 0;
#endif
			{VALUE v1,v2,v3;v1=params_new(Qnil, Qnil, Qnil, Qnil, Qnil, Qnil, Qnil);v2=Qnil;v3=dispatch2(block_var,v1,v2);$$=v3;}
		    }
		| '|' block_param opt_bv_decl '|'
			...
			$$ = $2;
#endif
			{VALUE v1,v2,v3;v1=escape_Qundef($2);v2=escape_Qundef($3);v3=dispatch2(block_var,v1,v2);$$=v3;}
		    }
		;
...
lambda		:   {
		  ...
		  lambda_body
			...
			nd_set_line($$, @3.end_pos.lineno);
#endif
			{VALUE v1,v2,v3;v1=$3;v2=$5;v3=dispatch2(lambda,v1,v2);$$=v3;}
			dyna_pop(p, $<vars>1);
		    }
		;
...
method_call	: fcall paren_args
		...
		| primary_value '[' opt_call_args rbracket
			...
			fixpos($$, $1);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=escape_Qundef($3);v3=dispatch2(aref,v1,v2);$$=v3;}
		    }
		;
...
brace_body	: {$<vars>$ = dyna_push(p);}
		  opt_block_param compstmt
			...
			$$ = NEW_ITER($2, $3, &@$);
#endif
			{VALUE v1,v2,v3;v1=escape_Qundef($2);v2=$3;v3=dispatch2(brace_block,v1,v2);$$=v3;}
			dyna_pop(p, $<vars>1);
		    }
		;
...
do_body 	: {$<vars>$ = dyna_push(p);}
		  ...
		  opt_block_param bodystmt
			...
			$$ = NEW_ITER($3, $4, &@$);
#endif
			{VALUE v1,v2,v3;v1=escape_Qundef($3);v2=$4;v3=dispatch2(do_block,v1,v2);$$=v3;}
			CMDARG_POP();
			dyna_pop(p, $<vars>1);
		    }
		;
...
case_body	: k_when args then
		  ...
		  cases
			...
			fixpos($$, $2);
#endif
			{VALUE v1,v2,v3,v4;v1=$2;v2=$4;v3=escape_Qundef($5);v4=dispatch3(when,v1,v2,v3);$$=v4;}
		    }
		;
...
opt_rescue	: k_rescue exc_list exc_var then
		  ...
		  opt_rescue
			...
			fixpos($$, $2?$2:$5);
#endif
			{VALUE v1,v2,v3,v4,v5;v1=escape_Qundef($2);v2=escape_Qundef($3);v3=escape_Qundef($5);v4=escape_Qundef($6);v5=dispatch4(rescue,v1,v2,v3,v4);$$=v5;}
		    }
		| none
		;
...
string_content	: tSTRING_CONTENT
		...
		| tSTRING_DBEG
		  ...
		  compstmt tSTRING_DEND
			...
			$$ = new_evstr(p, $7, &@$);
#endif
			{VALUE v1,v2;v1=$7;v2=dispatch1(string_embexpr,v1);$$=v2;}
		    }
		;
...
symbol		: tSYMBEG sym
			...
			$$ = $2;
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(symbol,v1);$$=v2;}
		    }
		;
...
f_bad_arg	: tCONSTANT
			...
			$$ = 0;
#endif
			{VALUE v1,v2;v1=$1;v2=dispatch1(param_error,v1);$$=v2;}ripper_error(p);
		    }
		| tIVAR
		    {
#if 0
